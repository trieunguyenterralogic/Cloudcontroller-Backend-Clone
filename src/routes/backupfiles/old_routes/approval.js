...
const {
    db_get_approval_type_list,
} = require("../../../dbcontrollers/approvalType.controller")
...
/**
 * @openapi
 *  /api/approval/approvalinventory:
 *   get:
 *       tags:
 *         - Approval
 *       summary: Form Notes
...
router.get("/approvalinventory", function (req, res, next) {
    ...
    db_get_approval_type_list(tenant_id, username, req.query)
        .then((notes) => {
            logger.debug("approval list is " + notes)
        ...
        .catch((err) => {
            logger.debug("approval list error " + err)
